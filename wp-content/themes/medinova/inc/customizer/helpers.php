...
function generate_do_control_inline_scripts() {
	wp_localize_script(
		'medinova-typography-customizer',
		'gp_customize',
		array(
	...
	wp_localize_script( 'medinova-typography-customizer', 'typography_defaults', generate_typography_default_fonts() );

	wp_enqueue_script( 'medinova-customizer-controls', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/controls/js/customizer-controls.js', array( 'customize-controls', 'jquery' ), GENERATE_VERSION, true );
	wp_localize_script( 'medinova-customizer-controls', 'medinova_defaults', generate_get_defaults() );
	wp_localize_script( 'medinova-customizer-controls', 'medinova_color_defaults', generate_get_color_defaults() );
	wp_localize_script( 'medinova-customizer-controls', 'medinova_typography_defaults', generate_get_default_fonts() );
	wp_localize_script( 'medinova-customizer-controls', 'medinova_spacing_defaults', generate_spacing_get_defaults() );

	wp_localize_script(
		'medinova-customizer-controls',
		'medinovaCustomizeControls',
		array(
			'mappedTypographyData' => array(
				'typography' => medinova_Typography_Migration::get_mapped_typography_data(),
				'fonts' => medinova_Typography_Migration::get_mapped_font_data(),
			),
		)
	);
	...
	if ( function_exists( 'wp_set_script_translations' ) ) {
		wp_set_script_translations( 'generate-customizer-controls', 'medinova' );
	}
