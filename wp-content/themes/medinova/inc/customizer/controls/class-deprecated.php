...
if ( ! class_exists( 'Generate_Google_Font_Dropdown_Custom_Control' ) ) {
	...
	class Generate_Google_Font_Dropdown_Custom_Control extends WP_Customize_Control { // phpcs:ignore
		...
		public function enqueue() {
			wp_enqueue_script( 'medinova-customizer-fonts', trailingslashit( get_template_directory_uri() ) . 'inc/js/typography-controls.js', array( 'customize-controls' ), GENERATE_VERSION, true );
			wp_localize_script( 'medinova-customizer-fonts', 'gp_customize', array( 'nonce' => wp_create_nonce( 'gp_customize_nonce' ) ) );
		}
		...
		public function to_json() {
			...
			$this->json['default_fonts_title'] = __( 'Default fonts', 'medinova' );
			$this->json['google_fonts_title'] = __( 'Google fonts', 'medinova' );
			$this->json['description'] = __( 'Font family', 'medinova' );
