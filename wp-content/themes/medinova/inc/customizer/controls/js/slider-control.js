wp.customize.controlConstructor['medinova-range-slider'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		var control = this,
		    ...
		    inputDefault,
		    changeAction,
			controlClass = '.customize-control-medinova-range-slider',
			footerActions = jQuery( '#customize-footer-actions' );
		
		// Set up the sliders
		jQuery( '.medinova-slider' ).each( function() {
		...
		jQuery( controlClass + ' .gp_range_value input[type=number]' ).on( 'input', function() {
			...
			jQuery( this ).closest( 'label' ).find( '.medinova-slider' ).slider( 'value', parseFloat(value)).change();
		});

		// Handle the reset button
		jQuery( controlClass + ' .medinova-reset' ).on( 'click', function() {
			var icon = jQuery( this ),
				...
				slider_value = visible_area.find( '.medinova-slider' ),
		...
		jQuery( controlClass + ' .medinova-range-slider-control' ).each( function() {
			var _this = jQuery( this );
