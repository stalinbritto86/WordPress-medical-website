...
class medinova_Dashboard {
	...
	public static function header() {
		?>
		<div class="medinova-dashboard-header">
			<div class="medinova-dashboard-header__title">
				<h1>
	...
	public static function navigation() {
		...
		if ( ! defined( 'GP_PREMIUM_VERSION' ) ) {
			$tabs['premium'] = array(
				'name' => __( 'Premium', 'medinova' ),
				'url' => 'https://medinova.com/premium',
				'class' => '',
				'external' => true,
			);
		}
		...
		$tabs['support'] = array(
			'name' => __( 'Support', 'medinova' ),
			'url' => 'https://medinova.com/support',
			'class' => '',
			'external' => true,
		);

		$tabs['documentation'] = array(
			'name' => __( 'Documentation', 'medinova' ),
			'url' => 'https://docs.medinova.com',
			'class' => '',
			'external' => true,
		);
		?>
		<div class="medinova-dashboard-header__navigation">
			<?php
			foreach ( $tabs as $tab ) {
				printf(
	...
	public function enqueue_scripts() {
		...
		if ( in_array( $current_screen->id, $dashboard_pages ) ) {
			...
			if ( 'appearance_page_generate-options' === $current_screen->id ) {
				...
				wp_set_script_translations( 'generate-dashboard', 'medinova' );
	...
	public function start_customizing() {
		echo '<div id="medinova-dashboard-app"></div>';
	}
	...
	public function go_pro() {
		echo '<div id="medinova-dashboard-go-pro"></div>';
	}
	...
	public function reset() {
		echo '<div id="medinova-reset"></div>';
	}
}

medinova_Dashboard::get_instance();
