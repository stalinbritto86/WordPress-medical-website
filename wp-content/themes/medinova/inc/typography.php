	...
	function generate_default_fonts_customize_register( $wp_customize ) {
		...
		$wp_customize->add_control(
			new Generate_Range_Slider_Control(
				...
				array(
					...
					'description' => __( 'Font size', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
		...
		$wp_customize->add_control(
			new Generate_Range_Slider_Control(
				...
				array(
					'type' => 'medinova-range-slider',
					'description' => __( 'Line height', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
		...
		$wp_customize->add_control(
			new Generate_Range_Slider_Control(
				...
				array(
					'type' => 'medinova-range-slider',
					'description' => __( 'Paragraph margin', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
		...
		$wp_customize->add_control(
			new Generate_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 1 (H1)', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
		...
		$wp_customize->add_control(
			new Generate_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 2 (H2)', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
		...
		$wp_customize->add_control(
			new Generate_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 3 (H3)', 'medinova' ),
					'section' => 'font_section',
					'settings' => array(
