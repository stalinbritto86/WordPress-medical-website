	...
	function generate_get_defaults() {
		return apply_filters(
			...
			array(
				...
				'global_colors' => array(
					array(
						'name' => __( 'Contrast', 'medinova' ),
						'slug' => 'contrast',
						'color' => '#222222',
					),
					array(
						/* translators: Contrast number */
						'name' => sprintf( __( 'Contrast %s', 'medinova' ), '2' ),
						'slug' => 'contrast-2',
						'color' => '#575760',
					),
					array(
						/* translators: Contrast number */
						'name' => sprintf( __( 'Contrast %s', 'medinova' ), '3' ),
						'slug' => 'contrast-3',
						'color' => '#b2b2be',
					),
					array(
						'name' => __( 'Base', 'medinova' ),
						'slug' => 'base',
						'color' => '#f0f0f0',
					),
					array(
						/* translators: Base number */
						'name' => sprintf( __( 'Base %s', 'medinova' ), '2' ),
						'slug' => 'base-2',
						'color' => '#f7f8f9',
					),
					array(
						/* translators: Base number */
						'name' => sprintf( __( 'Base %s', 'medinova' ), '3' ),
						'slug' => 'base-3',
						'color' => '#ffffff',
					),
					array(
						'name' => __( 'Accent', 'medinova' ),
						'slug' => 'accent',
						'color' => '#1e73be',
					),
				),
