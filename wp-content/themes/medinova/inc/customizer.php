...
if ( ! function_exists( 'generate_customize_register' ) ) {
	...
	function generate_customize_register( $wp_customize ) {
		...
		if ( method_exists( $wp_customize, 'register_section_type' ) ) {
			$wp_customize->register_section_type( 'medinova_Upsell_Section' );
		}
		...
		if ( ! defined( 'GP_PREMIUM_VERSION' ) ) {
			$wp_customize->add_section(
				new medinova_Upsell_Section(
					$wp_customize,
					'medinova_upsell_section',
					array(
						'pro_text' => __( 'Premium Modules Available', 'medinova' ),
						'pro_url' => generate_get_premium_url( 'https://medinova.com/premium' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'checkbox',
				'label' => __( 'Hide site title', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'checkbox',
				'label' => __( 'Hide site tagline', 'medinova' ),
				'section' => 'title_tagline',
				'priority' => 4,
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'checkbox',
				'label' => esc_html__( 'Place logo next to title', 'medinova' ),
				'section' => 'title_tagline',
		...
		$wp_customize->add_section(
			...
			array(
				'title' => esc_attr__( 'Colors', 'medinova' ),
				'priority' => 30,
			)
		);
		...
		medinova_Customize_Field::add_field(
			...
			array(
				...
				'label' => __( 'Choose Color', 'medinova' ),
				'section' => 'generate_colors_section',
				'choices' => array(
					'alpha' => true,
					'showPalette' => false,
		...
		$wp_customize->add_section(
			...
			array(
				'title' => esc_attr__( 'Typography', 'medinova' ),
				'priority' => 35,
		...
		medinova_Customize_Field::add_title(
			...
			array(
				...
				'title' => __( 'Font Manager', 'medinova' ),
			)
		);
		...
		medinova_Customize_Field::add_field(
			...
			array(
				'type' => 'select',
				'label' => __( 'Google font-display', 'medinova' ),
				'description' => sprintf(
					'<a href="%s" target="_blank" rel="noreferrer noopener">%s</a>',
					'https://developer.mozilla.org/en-US/docs/Web/CSS/@font-face/font-display',
					esc_html__( 'Learn about font-display', 'medinova' )
				),
				'section' => 'generate_typography_section',
				'choices' => array(
					'auto' => esc_html__( 'Auto', 'medinova' ),
					'block' => esc_html__( 'Block', 'medinova' ),
					'swap' => esc_html__( 'Swap', 'medinova' ),
					'fallback' => esc_html__( 'Fallback', 'medinova' ),
					'optional' => esc_html__( 'Optional', 'medinova' ),
				),
				'active_callback' => function() {
		...
		medinova_Customize_Field::add_title(
			...
			array(
				'section' => 'generate_typography_section',
				'title' => __( 'Typography Manager', 'medinova' ),
			)
		);
		...
		$wp_customize->add_control(
			new Generate_Range_Slider_Control(
				...
				'generate_settings[container_width]',
				array(
					'type' => 'medinova-range-slider',
					'label' => __( 'Container Width', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Top Bar Width', 'medinova' ),
				'section' => 'generate_top_bar',
				'choices' => array(
					'full' => __( 'Full', 'medinova' ),
					'contained' => __( 'Contained', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Top Bar Inner Width', 'medinova' ),
				'section' => 'generate_top_bar',
				'choices' => array(
					'full' => __( 'Full', 'medinova' ),
					'contained' => __( 'Contained', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Top Bar Alignment', 'medinova' ),
				'section' => 'generate_top_bar',
				'choices' => array(
					'left' => __( 'Left', 'medinova' ),
					'center' => __( 'Center', 'medinova' ),
					'right' => __( 'Right', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Header Presets', 'medinova' ),
				'section' => 'generate_layout_header',
				'choices' => array(
					'current' => __( 'Current', 'medinova' ),
					'default' => __( 'Default', 'medinova' ),
					'classic' => __( 'Classic', 'medinova' ),
					'nav-before' => __( 'Navigation Before', 'medinova' ),
					'nav-after' => __( 'Navigation After', 'medinova' ),
					'nav-before-centered' => __( 'Navigation Before - Centered', 'medinova' ),
					'nav-after-centered' => __( 'Navigation After - Centered', 'medinova' ),
					'nav-left' => __( 'Navigation Left', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Header Width', 'medinova' ),
				'section' => 'generate_layout_header',
				'choices' => array(
					'fluid-header' => __( 'Full', 'medinova' ),
					'contained-header' => __( 'Contained', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Inner Header Width', 'medinova' ),
				'section' => 'generate_layout_header',
				'choices' => array(
					'contained' => __( 'Contained', 'medinova' ),
					'full-width' => __( 'Full', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Header Alignment', 'medinova' ),
				'section' => 'generate_layout_header',
				'choices' => array(
					'left' => __( 'Left', 'medinova' ),
					'center' => __( 'Center', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Navigation Width', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'fluid-nav' => __( 'Full', 'medinova' ),
					'contained-nav' => __( 'Contained', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Inner Navigation Width', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'contained' => __( 'Contained', 'medinova' ),
					'full-width' => __( 'Full', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Navigation Alignment', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'left' => __( 'Left', 'medinova' ),
					'center' => __( 'Center', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Navigation Location', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'nav-below-header' => __( 'Below Header', 'medinova' ),
					'nav-above-header' => __( 'Above Header', 'medinova' ),
					'nav-float-right' => __( 'Float Right', 'medinova' ),
					'nav-float-left' => __( 'Float Left', 'medinova' ),
					'nav-left-sidebar' => __( 'Left Sidebar', 'medinova' ),
					'nav-right-sidebar' => __( 'Right Sidebar', 'medinova' ),
					'' => __( 'No Navigation', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			new Generate_Range_Slider_Control(
				...
				'generate_settings[nav_drop_point]',
				array(
					'label' => __( 'Navigation Drop Point', 'medinova' ),
					'sub_description' => __( 'The width when the navigation ceases to float and drops below your logo.', 'medinova' ),
					'section' => 'generate_layout_navigation',
					'settings' => array(
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Navigation Dropdown', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'hover' => __( 'Hover', 'medinova' ),
					'click' => __( 'Click - Menu Item', 'medinova' ),
					'click-arrow' => __( 'Click - Arrow', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Dropdown Direction', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'right' => __( 'Right', 'medinova' ),
					'left' => __( 'Left', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Navigation Search', 'medinova' ),
				'section' => 'generate_layout_navigation',
				'choices' => array(
					'enable' => __( 'Enable', 'medinova' ),
					'disable' => __( 'Disable', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Content Layout', 'medinova' ),
				'section' => 'generate_layout_container',
				'choices' => array(
					'separate-containers' => __( 'Separate Containers', 'medinova' ),
					'one-container' => __( 'One Container', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Container Alignment', 'medinova' ),
				'section' => 'generate_layout_container',
				'choices' => array(
					'boxes' => __( 'Boxes', 'medinova' ),
					'text' => __( 'Text', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Sidebar Layout', 'medinova' ),
				'section' => 'generate_layout_sidebars',
				'choices' => array(
					'left-sidebar' => __( 'Sidebar / Content', 'medinova' ),
					'right-sidebar' => __( 'Content / Sidebar', 'medinova' ),
					'no-sidebar' => __( 'Content (no sidebars)', 'medinova' ),
					'both-sidebars' => __( 'Sidebar / Content / Sidebar', 'medinova' ),
					'both-left' => __( 'Sidebar / Sidebar / Content', 'medinova' ),
					'both-right' => __( 'Content / Sidebar / Sidebar', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Blog Sidebar Layout', 'medinova' ),
				'section' => 'generate_layout_sidebars',
				'choices' => array(
					'left-sidebar' => __( 'Sidebar / Content', 'medinova' ),
					'right-sidebar' => __( 'Content / Sidebar', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Single Post Sidebar Layout', 'medinova' ),
				'section' => 'generate_layout_sidebars',
				'choices' => array(
					'left-sidebar' => __( 'Sidebar / Content', 'medinova' ),
					'right-sidebar' => __( 'Content / Sidebar', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Footer Width', 'medinova' ),
				'section' => 'generate_layout_footer',
				'choices' => array(
					'fluid-footer' => __( 'Full', 'medinova' ),
					'contained-footer' => __( 'Contained', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Inner Footer Width', 'medinova' ),
				'section' => 'generate_layout_footer',
				'choices' => array(
					'contained' => __( 'Contained', 'medinova' ),
					'full-width' => __( 'Full', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Footer Widgets', 'medinova' ),
				'section' => 'generate_layout_footer',
				'choices' => array(
					'0' => '0',
					'1' => '1',
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Footer Bar Alignment', 'medinova' ),
				'section' => 'generate_layout_footer',
				'choices' => array(
					'left' => __( 'Left', 'medinova' ),
					'center' => __( 'Center', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Back to Top Button', 'medinova' ),
				'section' => 'generate_layout_footer',
				'choices' => array(
					'enable' => __( 'Enable', 'medinova' ),
					'' => __( 'Disable', 'medinova' ),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Content Type', 'medinova' ),
				'section' => 'generate_blog_section',
				'choices' => array(
					'full' => __( 'Full Content', 'medinova' ),
					'excerpt' => __( 'Excerpt', 'medinova' ),
				),
			...
			$wp_customize->add_control(
				new Generate_Customize_Misc_Control(
					...
					array(
						'section' => 'generate_blog_section',
						'type' => 'addon',
						'label' => __( 'Learn more', 'medinova' ),
						'description' => __( 'More options are available for this section in our premium version.', 'medinova' ),
						'url' => generate_get_premium_url( 'https://medinova.com/premium/#blog', false ),
						'priority' => 30,
		...
		if ( ! apply_filters( 'generate_fontawesome_essentials', false ) ) {
			...
			$wp_customize->add_control(
				...
				array(
					'type' => 'checkbox',
					'label' => __( 'Load essential icons only', 'medinova' ),
					'description' => __( 'Load essential Font Awesome icons instead of the full library.', 'medinova' ),
		...
		if ( $show_flexbox_option ) {
			...
			$wp_customize->add_control(
				...
				array(
					'type' => 'select',
					'label' => __( 'Structure', 'medinova' ),
					'section' => 'generate_general_section',
					'choices' => array(
						'flexbox' => __( 'Flexbox', 'medinova' ),
						'floats' => __( 'Floats', 'medinova' ),
					),
					'description' => sprintf(
						...
						sprintf(
							...
							__( 'Switching your structure can change how your website displays. Review your website thoroughly before publishing this change, or use a staging site to review the potential changes. Learn more %s.', 'medinova' ),
							'<a href="https://docs.medinova.com/article/switching-from-floats-to-flexbox/" target="_blank" rel="noopener noreferrer">' . __( 'here', 'medinova' ) . '</a>'
						)
					),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Icon Type', 'medinova' ),
				'section' => 'generate_general_section',
				'choices' => array(
					'svg' => __( 'SVG', 'medinova' ),
					'font' => __( 'Font', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'select',
				'label' => __( 'Underline Links', 'medinova' ),
				'description' => __( 'Add underlines to your links in your main content areas.', 'medinova' ),
				'section' => 'generate_general_section',
				'choices' => array(
					'always' => __( 'Always', 'medinova' ),
					'hover' => __( 'On hover', 'medinova' ),
					'not-hover' => __( 'Not on hover', 'medinova' ),
					'never' => __( 'Never', 'medinova' ),
				),
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'checkbox',
				'label' => __( 'Combine CSS', 'medinova' ),
				'description' => __( 'Reduce the number of CSS file requests and use a lite version of our grid system.', 'medinova' ),
				'section' => 'generate_general_section',
		...
		$wp_customize->add_control(
			...
			array(
				'type' => 'checkbox',
				'label' => __( 'Cache dynamic CSS', 'medinova' ),
				'description' => __( 'Cache CSS generated by your options to boost performance.', 'medinova' ),
				'section' => 'generate_general_section',
			)
		);
		...
		if ( $show_legacy_typography_option ) {
			...
			$wp_customize->add_control(
				...
				array(
					'type' => 'checkbox',
					'label' => __( 'Use dynamic typography system', 'medinova' ),
					'description' => sprintf(
						/* translators: Learn more here */
						__( 'Switching to our dynamic typography system can change how your fonts display. Review your website thoroughly before publishing this change. Learn more %s.', 'medinova' ),
						'<a href="https://docs.medinova.com/article/switching-to-dynamic-typography/" target="_blank" rel="noopener noreferrer">' . __( 'here', 'medinova' ) . '</a>'
					),
					'section' => 'generate_general_section',
