...
class medinova_Theme_Update {
	...
	public static function init() {
		...
		$dynamic_css_data = get_option( 'medinova_dynamic_css_data', array() );
		...
		if ( ! empty( $dynamic_css_data ) ) {
			...
			update_option( 'medinova_dynamic_css_data', $dynamic_css_data );
		}
...
medinova_Theme_Update::get_instance();
