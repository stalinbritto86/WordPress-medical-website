...
if ( ! function_exists( 'generate_create_menu' ) ) {
	...
	/**
	 * Adds our "medinova" dashboard menu item
	 *
	 * @since 0.1
	 */
	function generate_create_menu() {
		$generate_page = add_theme_page( esc_html__( 'medinova', 'medinova' ), esc_html__( 'medinova', 'medinova' ), apply_filters( 'generate_dashboard_page_capability', 'edit_theme_options' ), 'generate-options', 'generate_settings_page' );
			...
			<div class="metabox-holder">
				<div class="gp-masthead clearfix">
					<div class="gp-container">
						<div class="gp-title">
							<a href="<?php echo generate_get_premium_url( 'https://medinova.com' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in function. ?>" target="_blank">medinova</a> <span class="gp-version"><?php echo esc_html( GENERATE_VERSION ); ?></span>
						</div>
						<div class="gp-masthead-links">
							<?php if ( ! defined( 'GP_PREMIUM_VERSION' ) ) : ?>
								<a style="font-weight: bold;" href="<?php echo generate_get_premium_url( 'https://medinova.com/premium/' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in function. ?>" target="_blank"><?php esc_html_e( 'Premium', 'medinova' ); ?></a>
							<?php endif; ?>
							<a href="<?php echo esc_url( 'https://medinova.com/support' ); ?>" target="_blank"><?php esc_html_e( 'Support', 'medinova' ); ?></a>
							<a href="<?php echo esc_url( 'https://docs.medinova.com' ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'medinova' ); ?></a>
						</div>
					</div>
				</div>
					...
					<div class="postbox-container clearfix" style="float: none;">
						<div class="grid-container grid-parent">
							...
							<div class="form-metabox grid-70" style="padding-left: 0;">
								...
								$modules = array(
									'Backgrounds' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#backgrounds', false ),
									),
									'Blog' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#blog', false ),
									),
									'Colors' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#colors', false ),
									),
									'Copyright' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#copyright', false ),
									),
									'Disable Elements' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#disable-elements', false ),
									),
									'Elements' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#elements', false ),
									),
									'Import / Export' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#import-export', false ),
									),
									'Menu Plus' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#menu-plus', false ),
									),
									'Secondary Nav' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#secondary-nav', false ),
									),
									'Sections' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#sections', false ),
									),
									'Site Library' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/site-library', false ),
									),
									'Spacing' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#spacing', false ),
									),
									'Typography' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#typography', false ),
									),
									'WooCommerce' => array(
										'url' => generate_get_premium_url( 'https://medinova.com/premium/#woocommerce', false ),
									),
								);
								...
								if ( ! defined( 'GP_PREMIUM_VERSION' ) ) :
									...
									<div class="postbox generate-metabox">
										<h3 class="hndle"><?php esc_html_e( 'Premium Modules', 'medinova' ); ?></h3>
												...
												foreach ( $modules as $module => $info ) {
													...
													<div class="add-on activated gp-clear addon-container grid-parent">
														...
														<div class="addon-action addon-addon-action" style="text-align:right;">
															<a href="<?php echo esc_url( $info['url'] ); ?>" target="_blank"><?php esc_html_e( 'Learn more', 'medinova' ); ?></a>
														</div>
													</div>
								...
								if ( function_exists( 'medinova_is_module_active' ) ) {
									if ( medinova_is_module_active( 'generate_package_typography', 'GENERATE_TYPOGRAPHY' ) ) {
										$typography_section = 'customize.php?autofocus[panel]=generate_typography_panel';
									}

									if ( medinova_is_module_active( 'generate_package_colors', 'GENERATE_COLORS' ) ) {
							...
							<div class="generate-right-sidebar grid-30" style="padding-right: 0;">
								<div class="postbox generate-metabox start-customizing">
									<h3 class="hndle"><?php esc_html_e( 'Start Customizing', 'medinova' ); ?></h3>
									<div class="inside">
										<ul>
											<?php
										...
										<p><?php esc_html_e( 'Want to learn more about the theme? Check out our extensive documentation.', 'medinova' ); ?></p>
										<a href="https://docs.medinova.com"><?php esc_html_e( 'Visit documentation &rarr;', 'medinova' ); ?></a>
									</div>
								</div>
								...
								<div class="postbox generate-metabox" id="gen-delete">
									<h3 class="hndle"><?php esc_html_e( 'Reset Settings', 'medinova' ); ?></h3>
									<div class="inside">
										<p><?php esc_html_e( 'Deleting your settings can not be undone.', 'medinova' ); ?></p>
										<form method="post">
											<p><input type="hidden" name="generate_reset_customizer" value="generate_reset_customizer_settings" /></p>
											<p>
												<?php
												$warning = 'return confirm("' . esc_html__( 'Warning: This will delete your settings.', 'medinova' ) . '")';
												wp_nonce_field( 'generate_reset_customizer_nonce', 'generate_reset_customizer_nonce' );

												submit_button(
													esc_attr__( 'Reset', 'medinova' ),
													'button-primary',
													'submit',
													false,
													array(
					...
					<div class="gp-options-footer">
						<span>
							...
							printf(
								...
								_x( 'Made with %s by Tom Usborne', 'made with love', 'medinova' ),
...
if ( ! function_exists( 'generate_admin_errors' ) ) {
	...
	function generate_admin_errors() {
		...
		if ( isset( $_GET['settings-updated'] ) && 'true' === $_GET['settings-updated'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Only checking. False positive.
			add_settings_error( 'generate-notices', 'true', esc_html__( 'Settings saved.', 'medinova' ), 'updated' );
		}

		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Only checking. False positive.
		if ( isset( $_GET['status'] ) && 'imported' === $_GET['status'] ) {
			add_settings_error( 'generate-notices', 'imported', esc_html__( 'Import successful.', 'medinova' ), 'updated' );
		}

		// phpcs:ignore WordPress.Security.NonceVerification.Recommended -- Only checking. False positive.
		if ( isset( $_GET['status'] ) && 'reset' === $_GET['status'] ) {
			add_settings_error( 'generate-notices', 'reset', esc_html__( 'Settings removed.', 'medinova' ), 'updated' );
		}
