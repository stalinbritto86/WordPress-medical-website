	...
	function generate_scripts() {
		...
		wp_localize_script(
			...
			apply_filters(
				...
				array(
					...
					'openSubMenuLabel' => esc_attr__( 'Open Sub-Menu', 'medinova' ),
					'closeSubMenuLabel' => esc_attr__( 'Close Sub-Menu', 'medinova' ),
				)
			)
		);
		...
		if ( 'enable' === generate_get_option( 'nav_search' ) ) {
			...
			wp_localize_script(
				...
				'medinovaNavSearch',
				array(
					'open' => esc_attr__( 'Open Search Bar', 'medinova' ),
					'close' => esc_attr__( 'Close Search Bar', 'medinova' ),
				)
			);
		}
...
if ( ! function_exists( 'generate_widgets_init' ) ) {
	...
	function generate_widgets_init() {
		$widgets = array(
			'sidebar-1' => __( 'Right Sidebar', 'medinova' ),
			'sidebar-2' => __( 'Left Sidebar', 'medinova' ),
			'header' => __( 'Header', 'medinova' ),
			'footer-1' => __( 'Footer Widget 1', 'medinova' ),
			'footer-2' => __( 'Footer Widget 2', 'medinova' ),
			'footer-3' => __( 'Footer Widget 3', 'medinova' ),
			'footer-4' => __( 'Footer Widget 4', 'medinova' ),
			'footer-5' => __( 'Footer Widget 5', 'medinova' ),
			'footer-bar' => __( 'Footer Bar', 'medinova' ),
			'top-bar' => __( 'Top Bar', 'medinova' ),
		);
