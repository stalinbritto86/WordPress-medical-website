 ...
 */
class medinova_HTML_Attributes {
	/**
	 * Class instance.
	 *
	 * @access private
	...
	public function site_header( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Site', 'medinova' );
	...
	public function primary_navigation( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Primary', 'medinova' );
	...
	public function mobile_menu_control_wrapper( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Mobile Toggle', 'medinova' );
	...
	public function entry_header( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Content', 'medinova' );
	...
	public function page_header( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Page', 'medinova' );
	...
	public function post_navigation( $attributes ) {
		if ( is_single() ) {
			...
			$attributes['aria-label'] = esc_attr__( 'Single Post', 'medinova' );
		} else {
			$attributes['class'] .= ' paging-navigation';
			$attributes['aria-label'] = esc_attr__( 'Archive Page', 'medinova' );
		}
	...
	public function comment_meta( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Comment meta', 'medinova' );
	...
	public function footer_entry_meta( $attributes ) {
		...
		$attributes['aria-label'] = esc_attr__( 'Entry meta', 'medinova' );

		return $attributes;
	}
}

medinova_HTML_Attributes::get_instance();
