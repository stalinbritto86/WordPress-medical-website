=== medinova ===
Contributors: edge22
Donate link: https://medinova.com/ongoing-development/
...
medinova is a lightweight WordPress theme built with a focus on speed and usability.

== Description ==

medinova is a lightweight WordPress theme built with a focus on speed and usability. Performance is important to us, which is why a fresh medinova install adds less than 10kb (gzipped) to your page size.

We take full advantage of the block editor (Gutenberg), which gives you more control over creating your content.

If you use page builders, medinova is the right theme for you. It is completely compatible with all major page builders, including Beaver Builder and Elementor.
...
medinova is fully responsive, uses valid HTML/CSS, and is translated into over 25 languages by our amazing community of users.
...
Learn more and check out our [powerful premium version](https://medinova.com).

== Installation ==

= From within WordPress =
1. Visit "Appearance > Themes > Add New"
1. Search for "medinova"
1. Install and activate

== Frequently Asked Questions ==

= Is medinova Free? =
Yes! medinova is a free theme, and always will be.

= Does medinova have a pro version? =
It does! medinova has a premium plugin which extends the available options in the theme.

You can learn more about GP Premium [here](https://medinova.com/premium).

= Where can I find documentation? =
medinova has extensive documentation you can find [here](https://docs.medinova.com).

= Do you offer support? =
Definitely. We offer support for the free theme in the [WordPress.org forums](https://wordpress.org/support/theme/medinova).

Premium customers have access to our very own [support forum](https://medinova.com/support).
...
= Does medinova have any widget areas? =
medinova has up to 9 widget areas which you can add widgets to in Appearance > Widgets.

= How can I make my site look like your screenshot? =
If you want to replicate the screenshot you see on WordPress.org, please refer to [this article](https://docs.medinova.com/article/replicating-the-screenshot/).

== License ==

medinova is licensed under the GNU General Public License v2 or later
...
For the changelog of earlier versions, please refer to our [development log](https://medinova.com/category/development/).
